...
public class OVRPlayerController : MonoBehaviour
{
	...
	protected virtual void Update()
	{
		...
		MoveThrottle.y /= motorDamp;//0;// (MoveThrottle.y > 0.0f) ? (MoveThrottle.y / motorDamp) : MoveThrottle.y;
		...
		//{
		//    bumpUpOffset = new Vector3(moveDirection.x, 0, moveDirection.z).magnitude;
	...
	public void UpdateTransform(OVRCameraRig rig)
	{
		...
		if (HmdRotatesY)
		{
			...
			tempT = Quaternion.Euler(centerEye.rotation.eulerAngles.x, centerEye.rotation.eulerAngles.y, centerEye.rotation.eulerAngles.z);
